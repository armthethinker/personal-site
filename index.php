...
<div class="container">
   ...
   <div class="row section-bio animated slideFadeInUp">
      <div class="col-sm-8 col-sm-offset-2 col-xs-12">
         ...
         <p class="lead"><strong>I use my wide background to help humans and computers interact.</strong> Currently, I am a Masters student at <strong>Carnegie Mellon University</strong> and at the <strong>Madeira Interactive Technologies Institute</strong> in Portugal, studying human-computer interaction with a focus on virtual reality. Recently I explored the user experience design implications for virtual reality in an internship called <a href="http://medium.com/humane-virtuality" target="_blank">Humane Virtuality</a>.</p>
